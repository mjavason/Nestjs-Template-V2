  ...
  welcomeAfter8hrs: (name: string) => {
    return `
            ...
            <head>
                ...
                <title>Welcome to Grandma Wura Hub</title>
                <style>
                    body {
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>We are thrilled to personally welcome you to <strong>Grandma Wura Hub</strong> and express our heartfelt gratitude for being an integral part of our beta community. As the founders, we are humbled by your trust and enthusiasm in embracing our vision.</p>
                        ...
                        <p>We are here to listen, learn, and collaborate with you every step of the way. Your journey with <strong>Grandma Wura Hub</strong> is not just about using a solution; it's about co-creating an experience that resonates with you on a personal level.</p>

                        <p>Thank you for joining us on this exciting adventure. Together, we can redefine what is possible and shape a future where “Grandma Wura Hub” becomes more than a solution—it becomes a transformative tool to help your children grow into the amazing leaders that they can be.</p>
                    ...
                    <div class="footer">
                        <p>&copy; ${new Date().getFullYear()} Grandma Wura Hub. All rights reserved.</p>
                    </div>
                </div>
            </body>
            </html>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Welcome to <strong>Grandma Wura Hub</strong>! We are thrilled to have you on board and excited to partner with you on your journey towards getting the best version of your child. Get ready to unlock a world of fun, adventure, and learning for your child.</p>
                        ...
                        <p>Once again, welcome to “Grandma Wura Hub.” We are excited to partner with you on your child's or ward’s development journey and look forward to hearing about the positive impact the Grandma Wura platform will have.</p>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Welcome to <strong>Grandma Wura Hub</strong>! To complete your registration and gain access to all our features, please verify your email address by clicking the button below.</p>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>We received a request to reset the password for your <strong>Grandma Wura Hub</strong> account. If you made this request, please click the button below to set a new password:</p>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Please be informed that your subscription to <strong>Grandma Wura Hub</strong> will be automatically renewed in 72 hours.</p>

                        <p>Kindly note that if you do not renew your subscription by then, you will lose access to the “Grandma Wura” app solution.</p>

                        <p>Thank you for choosing Grandma Wura Hub!</p>
...
<body>
    ...
    <div class="email-container">
        <div class="email-content">
            <img src="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" alt="Koala" width="170" height="50" />
            <p>Hi ${data.name},</p>
            <p>You have been invited to join PAR as an admin. Your default password is <strong>${data.password}</strong>. Use the forgot password process to set it to whatever you prefer.</p>
            <a href="${data.url}" target="_blank">Sign In</a>
            <p>Best,<br />PAR team</p>
            <hr class="divider" />
