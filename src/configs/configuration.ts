...
export default () => ({
  ...
  [ConfigurationKey.MAIL_HOST]: process.env.MAIL_HOST,
  [ConfigurationKey.MAIL_PORT]: parseInt(process.env.MAIL_PORT || '465', 10),
  [ConfigurationKey.MAIL_SENDER_FROM]: process.env.MAIL_SENDER_FROM,

  [ConfigurationKey.S3_ROOT_USER]: process.env.S3_ROOT_USER,
  [ConfigurationKey.S3_ROOT_PASSWORD]: process.env.S3_ROOT_PASSWORD,
  [ConfigurationKey.S3_ENDPOINT]: process.env.S3_ENDPOINT,
  [ConfigurationKey.S3_BUCKET]: process.env.S3_BUCKET,
  [ConfigurationKey.S3_REGION]: process.env.S3_REGION,
